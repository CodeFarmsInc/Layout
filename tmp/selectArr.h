...
#ifndef ZZ_selectArr_ARRAY_INCLUDED
#define ZZ_selectArr_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class selectArr_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    void** array;
    selectArr_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
public:
    ...
    static unsigned int size(Layout *hp); // returns allocated size
...
#endif // ZZ_selectArr_ARRAY_INCLUDED
