...
#ifndef ZZ_ndIndex_LINKARRAY_INCLUDED
#define ZZ_ndIndex_LINKARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class ndIndex_LinkArrayHolder : public ndIndex_ArrayHolder {
};

// ----------------------------------------------------------

class ndIndex_LinkArray : public ndIndex_Array {
public:
...
#endif // ZZ_ndIndex_LINKARRAY_INCLUDED
