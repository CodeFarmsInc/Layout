...
#ifndef ZZ_floatingNodeArr_ARRAY_INCLUDED
#define ZZ_floatingNodeArr_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class floatingNodeArr_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    void** array;
    floatingNodeArr_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
protected:
    ...
    static int sizeChange(Layout *hp,const unsigned int newSz,const int exact);
...
public:
    ...
    // ------------------------------------------------
    static void sort(cmpType cmp,Layout *hp){sort(hp,cmp);}
...
#endif // ZZ_floatingNodeArr_ARRAY_INCLUDED
