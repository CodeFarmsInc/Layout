...
#ifndef ZZ_ndIndex_ARRAY_INCLUDED
#define ZZ_ndIndex_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class ndIndex_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    void** array;
    ndIndex_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
#endif // ZZ_ndIndex_ARRAY_INCLUDED
