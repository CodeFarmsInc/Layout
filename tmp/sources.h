...
// EQUIVALENT OF:
// template <class Node> class sources_Ring2
// ----------------------------------------------------------
...
// ----------------------------------------------------------
#ifndef ZZ_sources_RING2_INCLUDED
#define ZZ_sources_RING2_INCLUDED
...
// ----------------------------------------------------------
class sources_Ring2Element {
public:
    Edge *next;
    Edge *prev;
    sources_Ring2Element(){ next=prev=NULL; }
};
...
public:
    ...
    sources_Ring2Iterator(){tail=nxt=NULL; dir=0;}
    ...
    Edge* const operator++();
    Edge* const operator--();
    sources_Ring2Iterator(Edge *p){start(p);}
};
    
#endif // ZZ_sources_RING2_INCLUDED
