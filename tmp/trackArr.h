...
#ifndef ZZ_trackArr_ARRAY_INCLUDED
#define ZZ_trackArr_ARRAY_INCLUDED

// ----------------------------------------------------------
// description of the cooperating classes
// ----------------------------------------------------------
class trackArr_ArrayHolder {
public:
    unsigned int sz; // present size
    int num,incr; // higest valid index,increment
    void** array;
    trackArr_ArrayHolder(){ sz=0; num= -1; incr=0; array=NULL;}
};
...
#endif // ZZ_trackArr_ARRAY_INCLUDED
