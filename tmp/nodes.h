...
// EQUIVALENT OF:
// template <class Node> class nodes_Ring1
// ----------------------------------------------------------
#ifndef ZZ_nodes_RING1_INCLUDED
#define ZZ_nodes_RING1_INCLUDED
...
// ----------------------------------------------------------
class nodes_Ring1Element {
public:
    Node *next;
    nodes_Ring1Element(){ next=NULL; }
};
...
public:
    ...
    nodes_Ring1Iterator(){tail=nxt=NULL;}
    ...
    void start(Node *p);
    Node* const operator++();
    nodes_Ring1Iterator(Node *p){start(p);}
};
    
#endif // ZZ_nodes_RING1_INCLUDED
