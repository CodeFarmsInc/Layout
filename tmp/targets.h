...
// EQUIVALENT OF:
// template <class Node> class targets_Ring2
// ----------------------------------------------------------
...
// ----------------------------------------------------------
#ifndef ZZ_targets_RING2_INCLUDED
#define ZZ_targets_RING2_INCLUDED
...
// ----------------------------------------------------------
class targets_Ring2Element {
public:
    Edge *next;
    Edge *prev;
    targets_Ring2Element(){ next=prev=NULL; }
};
...
public:
    ...
    targets_Ring2Iterator(){tail=nxt=NULL; dir=0;}
    ...
    Edge* const operator++();
    Edge* const operator--();
    targets_Ring2Iterator(Edge *p){start(p);}
};
    
#endif // ZZ_targets_RING2_INCLUDED
