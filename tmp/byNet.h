...
// EQUIVALENT OF:
// template <class Node> class byNet_Ring2
// ----------------------------------------------------------
...
// ----------------------------------------------------------
#ifndef ZZ_byNet_RING2_INCLUDED
#define ZZ_byNet_RING2_INCLUDED
...
// ----------------------------------------------------------
class byNet_Ring2Element {
public:
    Edge *next;
    Edge *prev;
    byNet_Ring2Element(){ next=prev=NULL; }
};
...
public:
    ...
    byNet_Ring2Iterator(){tail=nxt=NULL; dir=0;}
    ...
    Edge* const operator++();
    Edge* const operator--();
    byNet_Ring2Iterator(Edge *p){start(p);}
};
    
#endif // ZZ_byNet_RING2_INCLUDED
